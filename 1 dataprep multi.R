...
Nodata <- names(which(colSums(is.na(plates.prepped)) == nrow(plates.prepped))) #Auto_superscaffold23_11523675
...
save(plates.prepped.auto,plates.sex,individual.info,file="platesprepped.RData")
